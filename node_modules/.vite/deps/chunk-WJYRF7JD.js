...
var TimeClock = React5.forwardRef(function TimeClock2(inProps, ref) {
  const utils = useUtils();
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimeClock"
  ...
  const isTimeDisabled = React5.useCallback((rawValue, viewType) => {
  ...
  const viewProps = React5.useMemo(() => {
    switch (view) {
      case "hours": {
...
var DigitalClock = React6.forwardRef(function DigitalClock2(inProps, ref) {
  ...
  const isTimeDisabled = React6.useCallback((valueToCheck) => {
    const isAfter = createIsAfterIgnoreDatePart(disableIgnoringDatePartForTimeValidation, utils);
    const containsValidTime = () => {
  ...
  const timeOptions = React6.useMemo(() => {
...
//# sourceMappingURL=chunk-WJYRF7JD.js.map
