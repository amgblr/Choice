...
var cssClass = (name) => `${cssPrefix$3}${name}`;
var cssVar = (name) => `--${cssPrefix$3}${name}`;
...
var devicePixelRatio = () => (hasWindow() ? window === null || window === void 0 ? void 0 : window.devicePixelRatio : void 0) || 1;
...
(function(SwipeState2) {
  ...
  SwipeState2[SwipeState2["PULL_DOWN"] = 2] = "PULL_DOWN";
...
(function(Gesture2) {
  ...
  Gesture2[Gesture2["PULL_DOWN"] = 2] = "PULL_DOWN";
})(Gesture || (Gesture = {}));
...
function Controller({ children, ...props }) {
  ...
  const setPullDownOffset = (offset) => {
    ...
    (_a2 = containerRef.current) === null || _a2 === void 0 ? void 0 : _a2.style.setProperty(cssVar("pull_down_offset"), `${Math.round(offset)}px`);
...
function Carousel({ carousel: { finite, preload, padding, spacing } }) {
  ...
  if ((slides === null || slides === void 0 ? void 0 : slides.length) > 0) {
    for (let i = currentIndex - preload; i < currentIndex; i += 1) {
      ...
      items.push(!finite || i >= 0 ? React.createElement(CarouselSlide, { key, slide: slides[(i + preload * slides.length) % slides.length], offset: i - currentIndex }) : React.createElement(Placeholder, { key }));
    }
    items.push(React.createElement(CarouselSlide, { key: globalIndex, slide: slides[currentIndex], offset: 0 }));
    for (let i = currentIndex + 1; i <= currentIndex + preload; i += 1) {
      const key = globalIndex + i - currentIndex;
      items.push(!finite || i <= slides.length - 1 ? React.createElement(CarouselSlide, { key, slide: slides[i % slides.length], offset: i - currentIndex }) : React.createElement(Placeholder, { key }));
    }
  }
...
function NavigationButton({ label: label2, icon, renderIcon, action, onClick, disabled }) {
  return React.createElement(IconButton, { label: label2, icon, renderIcon, className: cssClass(`navigation_${action}`), disabled, onClick, ...useLoseFocus(useController().focus, disabled) });
}
...
function Lightbox({ carousel, animation, render, toolbar, controller, on, plugins, slides, index, ...restProps }) {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      { slides: slides || defaultSlides, index: index || defaultIndex },
      React.createElement(
        TimeoutsProvider,
        null,
...
//# sourceMappingURL=chunk-JEAYEH35.js.map
