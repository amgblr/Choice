...
var _excluded = ["className", "delay", "FabProps", "icon", "id", "open", "TooltipClasses", "tooltipOpen", "tooltipPlacement", "tooltipTitle"];
...
var SpeedDialAction = React.forwardRef(function SpeedDialAction2(inProps, ref) {
  ...
  const fab = (0, import_jsx_runtime.jsx)(SpeedDialActionFab, _extends({
    size: "small",
  ...
  if (tooltipOpenProp) {
    return (0, import_jsx_runtime2.jsxs)(SpeedDialActionStaticTooltip, _extends({
      id,
      ref,
  ...
  return (0, import_jsx_runtime.jsx)(Tooltip_default, _extends({
    id,
    ref,
    title: tooltipTitle,
...
//# sourceMappingURL=chunk-KALFDRXD.js.map
