...
var Autocomplete = React.forwardRef(function Autocomplete2(inProps, ref) {
  ...
  const defaultRenderOption = (props2, option) => (0, import_jsx_runtime.jsx)("li", _extends({}, props2, {
  ...
  return (0, import_jsx_runtime2.jsxs)(React.Fragment, {
    children: [(0, import_jsx_runtime.jsx)(AutocompleteRoot, _extends({
    ...
    })), anchorEl ? (0, import_jsx_runtime.jsx)(AutocompletePopper, _extends({
      as: PopperComponent,
      disablePortal,
      style: {
      ...
      children: (0, import_jsx_runtime2.jsxs)(AutocompletePaper, _extends({
        ownerState,
        as: PaperComponent
      }, paperSlotProps, {
        ...
        }) : null, groupedOptions.length > 0 ? (0, import_jsx_runtime.jsx)(AutocompleteListbox, _extends({
          as: ListboxComponent,
...
//# sourceMappingURL=chunk-ECHYITES.js.map
