import {
  require_shim
} from "./chunk-ZEAPEBVR.js";
import {
  _defineProperty
} from "./chunk-SGTXMCE7.js";
import "./chunk-KH4DSOX4.js";
  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    if (true) {
      (function() {
        ...
        var useRef5 = React4.useRef, useEffect4 = React4.useEffect, useMemo4 = React4.useMemo, useDebugValue2 = React4.useDebugValue;
...
`;
    ...
    if (forwardRef) {
      const _forwarded = import_react5.default.forwardRef(function forwardConnectRef(props, ref2) {
...
function useMemoOne(getResult, inputs) {
  var initial = (0, import_react7.useState)(function() {
    return {
      inputs,
      result: getResult()
    };
  })[0];
  var isFirstRun = (0, import_react7.useRef)(true);
  var committed = (0, import_react7.useRef)(initial);
...
function useStyleMarshal(contextId, nonce) {
  ...
  const alwaysRef = (0, import_react8.useRef)(null);
  const dynamicRef = (0, import_react8.useRef)(null);
...
var getWindowFromEl = (el) => {
  var _a;
  return ((_a = el == null ? void 0 : el.ownerDocument) == null ? void 0 : _a.defaultView) || window;
};
...
function useFocusMarshal(contextId) {
  const entriesRef = (0, import_react8.useRef)({});
  const recordRef = (0, import_react8.useRef)(null);
  const restoreFocusFrameRef = (0, import_react8.useRef)(null);
...
function useRegistry() {
  ...
  (0, import_react8.useEffect)(() => {
    return function unmount() {
      if (import_react8.default.version.startsWith("16") || import_react8.default.version.startsWith("17")) {
...
function useDeprecatedUniqueId(prefix3, options) {
  if (options === void 0) {
    options = defaults;
  }
...
function useUniqueId(prefix3, options) {
  ...
  const id = import_react8.default.useId();
  return useMemo3(() => `${prefix3}${options.separator}${id}`, [options.separator, prefix3, id]);
}
var useUniqueId$1 = "useId" in import_react8.default ? useUniqueId : useDeprecatedUniqueId;
...
function usePrevious(current) {
  const ref2 = (0, import_react8.useRef)(current);
  (0, import_react8.useEffect)(() => {
...
function useMouseSensor(api) {
  const phaseRef = (0, import_react8.useRef)(idle$1);
  const unbindEventsRef = (0, import_react8.useRef)(noop$2);
...
function useKeyboardSensor(api) {
  const unbindEventsRef = (0, import_react8.useRef)(noop$1);
  const startCaptureBinding = useMemo3(() => ({
    eventName: "keydown",
...
function useTouchSensor(api) {
  const phaseRef = (0, import_react8.useRef)(idle);
  const unbindEventsRef = (0, import_react8.useRef)(noop$2);
...
function useSensorMarshal(_ref4) {
  ...
  const lockAPI = (0, import_react8.useState)(() => create())[0];
...
function App(props) {
  ...
  const lazyStoreRef = (0, import_react8.useRef)(null);
...
function useUniqueContextId() {
  return import_react8.default.useId();
}
var useUniqueContextId$1 = "useId" in import_react8.default ? useUniqueContextId : useDeprecatedUniqueContextId;
function resetServerContext() {
  if ("useId" in import_react8.default) {
...
function DragDropContext(props) {
  ...
  return import_react8.default.createElement(ErrorBoundary, null, (setCallbacks) => import_react8.default.createElement(App, {
    nonce: props.nonce,
    contextId,
    setCallbacks,
    dragHandleUsageInstructions: dragHandleUsageInstructions2,
...
function useDraggablePublisher(args) {
  ...
  const publishedRef = (0, import_react8.useRef)(entry);
  const isFirstPublishRef = (0, import_react8.useRef)(true);
  useLayoutEffect2(() => {
...
function useClonePropValidation(isClone) {
  useDev(() => {
    const initialRef = (0, import_react8.useRef)(isClone);
    useDevSetupWarning(() => {
...
function useRequiredContext(Context) {
  const result = (0, import_react8.useContext)(Context);
...
var Draggable = (props) => {
  const ref2 = (0, import_react8.useRef)(null);
  const setRef = useCallback2(function(el) {
    if (el === void 0) {
      el = null;
    }
    ref2.current = el;
  ...
  return import_react8.default.createElement(import_react8.default.Fragment, null, children(provided, mapped.snapshot, rubric));
};
...
function PrivateDraggable(props) {
  ...
  return import_react8.default.createElement(ConnectedDraggable$1, props);
}
...
function useDroppablePublisher(args) {
  const whileDraggingRef = (0, import_react8.useRef)(null);
  ...
  const publishedDescriptorRef = (0, import_react8.useRef)(descriptor);
...
var Placeholder = (props) => {
  const animateOpenTimerRef = (0, import_react8.useRef)(null);
  ...
  const [isAnimatingOpenOnMount, setIsAnimatingOpenOnMount] = (0, import_react8.useState)(props.animate === "open");
  (0, import_react8.useEffect)(() => {
    if (!isAnimatingOpenOnMount) {
      return noop;
    }
...
var AnimateInOut = class extends import_react8.default.PureComponent {
  constructor() {
    super(...arguments);
    this.state = {
...
var Droppable = (props) => {
  const appContext = (0, import_react8.useContext)(AppContext);
  !appContext ? true ? invariant2(false, "Could not find app context") : invariant2(false) : void 0;
  const {
    contextId,
    isMovementAllowed: isMovementAllowed2
  } = appContext;
  const droppableRef = (0, import_react8.useRef)(null);
  const placeholderRef = (0, import_react8.useRef)(null);
  const {
    children,
    droppableId,
    type,
  ...
  const setDroppableRef = useCallback2(function(value) {
    if (value === void 0) {
      value = null;
    }
  ...
  const setPlaceholderRef = useCallback2(function(value) {
    if (value === void 0) {
      value = null;
    }
  ...
  const placeholder2 = useMemo3(() => import_react8.default.createElement(AnimateInOut, {
  ...
  function getClone() {
    ...
    const node = import_react8.default.createElement(PrivateDraggable, {
