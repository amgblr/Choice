import {
  ...
  stringify2,
  svg
} from "./chunk-6R2ODOLJ.js";
import {
  visit
} from "./chunk-PSBHCS2Y.js";
  ...
  function(tree, file, options) {
    ...
    if (options && options.passThrough) {
      while (++index < options.passThrough.length) {
        one3.handlers[options.passThrough[index]] = stitch;
      }
    }
    const result = fromParse5(
      documentMode(tree) ? document() : fragment2(),
      file
    );
    if (stitches) {
      visit(result, "comment", (node, index2, parent) => {
        const stitch2 = (
          /** @type {Stitch} */
          /** @type {unknown} */
          node
        );
        if (stitch2.value.stitch && parent !== null && index2 !== null) {
          parent.children[index2] = stitch2.value.stitch;
          return index2;
        }
      });
    }
