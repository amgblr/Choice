...
var require_match = __commonJS({
  "node_modules/autosuggest-highlight/match/index.js"(exports, module) {
    !function(e, t) {
      ...
      return e = { 772: (e2, t2, o) => {
        ...
        e2.exports = function(e3, t3, o2) {
          ...
          return (t3 = r(t3)).trim().split(u).filter((e4) => e4.length > 0).reduce((e4, t4) => {
            ...
            let a2, A;
            if (a2 = s2.exec(l), o2.requireMatchAll && null === a2)
              return l = "", [];
            for (; a2; ) {
              A = a2.index;
              const t5 = r2 - c.slice(A, A + r2).join("").length, i2 = A - c.slice(0, A).join("").length, n2 = [A + i2, A + r2 + i2 + t5];
              if (n2[0] !== n2[1] && e4.push(n2), l = l.slice(0, A) + new Array(r2 + 1).join(" ") + l.slice(A + r2), !o2.findAllOccurrences)
                break;
              a2 = s2.exec(l);
            }
            return e4;
...
export default require_match();
//# sourceMappingURL=autosuggest-highlight_match.js.map
