...
function useTreeItem(nodeId) {
  const {
    ...
    selectRange,
    toggleExpansion
  } = React.useContext(TreeViewContext_default);
...
var TreeItemContent = React2.forwardRef(function TreeItemContent2(props, ref) {
  ...
  return (
    ...
    (0, import_jsx_runtime2.jsxs)("div", _extends({
...
var TreeItem = React3.forwardRef(function TreeItem2(inProps, ref) {
  ...
  const {
    ...
    unregisterNode,
    treeId
  } = React3.useContext(TreeViewContext_default);
  let id = null;
  if (idProp != null) {
    id = idProp;
...
//# sourceMappingURL=@mui_lab_TreeItem.js.map
