...
var DescendantContext = React2.createContext({});
if (true) {
...
function useDescendant(descendant) {
  ...
  const {
    ...
    descendants = [],
    parentId = null
  } = React2.useContext(DescendantContext);
...
function DescendantProvider(props) {
  ...
  const [items, set] = React2.useState([]);
  const registerDescendant = React2.useCallback((_ref) => {
    let {
      element
  ...
  const unregisterDescendant = React2.useCallback((element) => {
...
//# sourceMappingURL=chunk-ZJZEBUXH.js.map
