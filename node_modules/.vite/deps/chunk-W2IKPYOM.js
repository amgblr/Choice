...
var _excluded2 = ["alignItems", "autoFocus", "button", "children", "className", "component", "components", "componentsProps", "ContainerComponent", "ContainerProps", "dense", "disabled", "disableGutters", "disablePadding", "divider", "focusVisibleClassName", "secondaryAction", "selected", "slotProps", "slots"];
...
var ListItem = React.forwardRef(function ListItem2(inProps, ref) {
  ...
  const {
    ...
    slotProps = {},
    slots = {}
  } = props, ContainerProps = _objectWithoutPropertiesLoose(props.ContainerProps, _excluded), other = _objectWithoutPropertiesLoose(props, _excluded2);
  ...
  if (hasSecondaryAction) {
    ...
    return (0, import_jsx_runtime.jsx)(ListContext_default.Provider, {
      value: childContext,
      children: (0, import_jsx_runtime2.jsxs)(ListItemContainer, _extends({
        as: ContainerComponent,
        className: clsx_m_default(classes.container, ContainerClassName),
        ref: handleRef,
        ownerState
      }, ContainerProps, {
        children: [(0, import_jsx_runtime.jsx)(Root, _extends({}, rootProps, !isHostComponent(Root) && {
          as: Component,
  ...
  return (0, import_jsx_runtime.jsx)(ListContext_default.Provider, {
    ...
    children: (0, import_jsx_runtime2.jsxs)(Root, _extends({}, rootProps, {
      ...
      children: [children, secondaryAction && (0, import_jsx_runtime.jsx)(ListItemSecondaryAction_default, {
...
//# sourceMappingURL=chunk-W2IKPYOM.js.map
